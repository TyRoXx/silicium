...
{
	Si::absolute_path a, b("b"), c("c"), c2("c");
...
BOOST_AUTO_TEST_CASE(absolute_path_less_than)
{
	...
	m[Si::absolute_path("a")] = 1;
	m[Si::absolute_path("b")] = 2;
	m[Si::absolute_path("c")] = 3;
	BOOST_CHECK_EQUAL(3, m.size());
	BOOST_CHECK_EQUAL(1, m[Si::absolute_path("a")]);
	BOOST_CHECK_EQUAL(2, m[Si::absolute_path("b")]);
	BOOST_CHECK_EQUAL(3, m[Si::absolute_path("c")]);
}
...
{
	BOOST_CHECK_EQUAL(Si::absolute_path("/a/b"), Si::absolute_path("/a") / Si::relative_path("b"));
}
