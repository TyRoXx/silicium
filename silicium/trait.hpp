...
#define SILICIUM_DETAIL_MAKE_PARAMETERS(array)                                                                         \
	(BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE(array), SILICIUM_DETAIL_MAKE_PARAMETER, array))
...
#define SILICIUM_DETAIL_MAKE_PURE_VIRTUAL_METHOD(r, data, elem)                                                        \
	virtual BOOST_PP_TUPLE_ELEM(4, 2, elem) BOOST_PP_TUPLE_ELEM(4, 0, elem)                                            \
	    SILICIUM_DETAIL_MAKE_PARAMETERS(BOOST_PP_TUPLE_ELEM(4, 1, elem)) BOOST_PP_TUPLE_ELEM(4, 3, elem) = 0;
...
#define SILICIUM_DETAIL_MAKE_INTERFACE(name, typedefs, methods)                                                        \
	...
	{                                                                                                                  \
		...
		typedefs BOOST_PP_SEQ_FOR_EACH(SILICIUM_DETAIL_MAKE_PURE_VIRTUAL_METHOD, _, methods)                           \
	};
...
#define SILICIUM_DETAIL_MAKE_ERASER_METHOD(r, data, elem)                                                              \
	virtual BOOST_PP_TUPLE_ELEM(4, 2, elem) BOOST_PP_TUPLE_ELEM(4, 0, elem)                                            \
	    SILICIUM_DETAIL_MAKE_PARAMETERS(BOOST_PP_TUPLE_ELEM(4, 1, elem)) BOOST_PP_TUPLE_ELEM(4, 3, elem)               \
	        SILICIUM_OVERRIDE                                                                                          \
	{                                                                                                                  \
