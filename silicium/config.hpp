...
#	endif
#else
#	define SILICIUM_UNREACHABLE() throw ::std::logic_error("SILICIUM_UNREACHABLE was executed at " __FILE__ ":" BOOST_STRINGIZE(__LINE__))
#endif
...
#ifdef _MSC_VER
#	define SILICIUM_COMPILER_HAS_CONSTEXPR_NUMERIC_LIMITS 0
#else
#	define SILICIUM_COMPILER_HAS_CONSTEXPR_NUMERIC_LIMITS 1
#endif
